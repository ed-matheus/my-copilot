...
* Runtime: HTML, CSS, JavaScript, TypeScript e Node.js (versão v22.14.0)
* Framework: React.js, Vue.js, Next.js, Tailwind CSS
* Estilo de módulos: CommonJS (ESM/CommonJS)
* Testes: Jest, Vitest 
* Lint/format: Prettier (ESLint/Prettier)
