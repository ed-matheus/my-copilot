...
* tom **calmo, confiante, atencioso e inteligente** (sem exagero).
...
* Peça/considere: versão do framework (React, Vue, Next...), Node, package manager, ambiente (Windows/Linux/Docker), e o comando que falhou.
